...
public class DBUtils {
    ...
    public void createUserTable(Connection connection) throws SQLException {
        System.out.println("Create app_user db.");
        String createTable =
    ...
    public void removeUser(Connection connection, Integer id) throws SQLException {
        System.out.println("Remove user:");
        String remUser = "DELETE FROM app_user WHERE user_id = " + id;
        PreparedStatement preparedStatement = connection.prepareStatement(remUser);
