...
@ContextConfiguration(locations = "classpath:spring-context-text.xml")
public class DepartmentConsumerRestTest {
    ...
    public void init() {
        ...
        departmentDTO1.setDepartmentId(2);
        departmentDTO2.setDepartmentName("name2");
        department = new Department("name", "some description");
    ...
    public void getAllDepartments() {
        ...
        List<DepartmentDTO> results = departmentService.getDepartmentsDTO();
